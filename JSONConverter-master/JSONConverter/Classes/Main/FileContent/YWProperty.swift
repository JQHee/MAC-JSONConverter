...
class YWProperty {
    ...
    func toString() -> (String, String){
        ...
        case .Dictionary:
            ...
            case .Swift, .HandyJSON:
                propertyStr = "\tvar \(propertyKey): \(propertyKey.className(withPrefix: prefixStr)) = \(propertyKey.className(withPrefix: prefixStr))()\n"
            case .SwiftyJSON:
                propertyStr = "\tvar \(propertyKey): \(propertyKey.className(withPrefix: prefixStr)) = \(propertyKey.className(withPrefix: prefixStr))(json: JSON.null)\n"
